    ...
    <div className={howWedoItClasses} id={"section-1"}>
      <Container>
        ...
        <div className={"text-center py-[80px]"}>
            <TextSpacer>
          <Paragraph>
          Our Customer Service Center is available Monday through Friday from 8.00 am to 4.00
pm.
          </Paragraph>
            </TextSpacer>
        </div>
        ...
        <div className={"grid xs:text-center sm:text-center md:text-center xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 2xL:grid-cols-4 3xl:grid-cols-4 4xl:grid-cols-4 text-light"}>
          <BorderedContainer>
            <TextSpacer>
              <h4 className={semiTitleClasses}>Registered office:</h4>
              <br />
              <Paragraph>
                Jagodne Sp. z o. o. <br />
                Brzeska 65, <br />
          ...
          <BorderedContainer hideLeftBorder={true}>
            <TextSpacer>
              <h4 className={semiTitleClasses}>Manufacturing plant:</h4>
              <br />
              <Paragraph>
                Karowa 38A,
                <br />
