                                    ...
                                    <>
                                        <motion.div
                                            ...
                                            <div className={mainTitleWrapper}>
                                                <PageTitle >
                                                    Twój pomysł na inwestycję w skali <span className={'text-accent'}>big picture</span>
                                                </PageTitle>
                                            </div>
                                            <div className={paragraphWrapper}>

                                                <Paragraph>
                                                    Nie boimy się odważnych i złożonych projektów zorientowanych na maksymalizację zwrotu z inwestycji. Budujemy dziś z myślą o potrzebach jutra.
                                                </Paragraph>
