...
const featuredPostContent = classNames('bg-accent xs:w-full sm:w-full  md:w-full lg:w-full w-3/10 flex flex-col justify-center',
    ...
    <div className={howWedoItClasses} id={"section-1"}>
      <Container>
          ...
          <div className="xs:w-full sm:w-full  md:w-full lg:w-full w-7/10  ">
            <img className={featuredImg} src={'/images/aktualnosci_8.png'} alt={'aktualnosci'} />
          </div>
          <div className={featuredPostContent}>
              <TextSpacer>
              <div className={dateClasses}>10/04/2023</div>
              <h3 className={titleClasses}>Nullam quis risus eget urna mollis ornare vel eu leo. Aenean eu leo quam. </h3>
                  <br/>
                  <SmallButton color={'light'} link={'#'} >Czystaj więcej</SmallButton>
              </TextSpacer>
              </div>
